...
import { Button, Container, Typography, Stack, TextField } from '@mui/material';
...
const AddQuestionForSpace = (props: any) => {
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await post("/Save/AddQuestionForSpace", newQuestion);
...
export default AddQuestionForSpace;
